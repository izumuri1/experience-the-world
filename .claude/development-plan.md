...
**タスク:**
- [ ] **OpenWeather APIキーの設定（重要！）**
  - [ ] https://openweathermap.org/api でサインアップ
  - [ ] APIキーを取得（無料プラン）
  - [ ] プロジェクトルートに `.env` ファイルを作成
  - [ ] `EXPO_PUBLIC_OPENWEATHER_API_KEY=あなたのAPIキー` を記述
  - [ ] アプリを再起動して天気情報が表示されることを確認
- [ ] 統合テスト
  - [ ] 写真撮影から振り返りまでの全フロー
  - [ ] オフライン動作の確認
  - [ ] パーミッション処理の確認
...
| ステップ5: 音声メモ | 10/30 | ✅ 完了 |
| ステップ6: タイムライン | 10/30 PM | ⏳ 未着手 |
| ステップ7: ナビゲーション | 10/31 AM | ⏳ 未着手 |
| ステップ8: 訪問国表示 | 10/31 PM | ⏳ 未着手 |
| ステップ9: 最終調整 | 10/31 PM | ⏳ 未着手 |

- ✅ ステップ6: タイムライン画面の実装  - ✅ TimelineScreen実装（日付グルーピング、空の状態）  - ✅ ExperienceCard実装  - ✅ ExperienceDetailScreen実装（削除機能）  - ✅ モーダル統合とUX改善  - ✅ iPhone実機テスト完了
---
**次のタスク:**- ✅ ステップ6: タイムライン画面の実装（完了）- 🔄 ステップ7: ナビゲーションとホーム画面の実装（次のステップ）
